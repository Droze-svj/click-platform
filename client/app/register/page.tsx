...
import {
  ArrowLeft, ArrowRight, Check, ChevronRight, RefreshCw, Sparkles, Target,
  Dumbbell, BarChart3, BookOpen, Cpu, Briefcase, Drama, Globe,
  Coins, Baby, Palette, Leaf, FlaskConical, Gamepad2,
...
/**
 * Niche catalogue — every value maps 1:1 to a key in NICHE_PLAYBOOKS
 * (server/services/marketingKnowledge.js). The descriptions below are drawn
 * straight from each playbook's real `voice` + `angles` — what Click will
 * actually do for that niche. NO invented metrics or fabricated benefits.
 */
const NICHE_OPTIONS: { value: string; label: string; icon: LucideIcon; blurb: string }[] = [
