      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-16 relative z-50">
        <div className="flex items-center gap-12">
          ...
          <div className="w-24 h-24 bg-indigo-500/10 border-2 border-indigo-500/20 rounded-[3rem] flex items-center justify-center shadow-3xl relative group overflow-hidden">
             ...
             <Layers size={48} className="text-indigo-400 relative z-10 group-hover:scale-125 transition-transform duration-300" />
          </div>
          <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-16">
                  {templates.map((template, idx) => (
                    <motion.div
                      ...
                      layout
                      key={template._id}
                      className="group bg-white/[0.02] border-2 border-white/5 rounded-[5rem] p-12 hover:border-indigo-500/30 hover:bg-white/[0.05] transition-all duration-300 shadow-[0_50px_100px_rgba(0,0,0,0.8)] flex flex-col min-h-[580px] relative overflow-hidden h-full"
                    >
                      ...
                      {template.preview?.thumbnail && (
                        <div className="relative mb-10 rounded-[3rem] overflow-hidden aspect-video border-2 border-white/10 shadow-3xl group-hover:border-indigo-500/30 transition-all duration-300 group-hover:shadow-[0_0_100px_rgba(99,102,241,0.2)]">
                          <img
                      ...
                      <div className="mt-auto space-y-10 relative z-10">
                        <div className="flex items-center gap-6 text-[11px] font-black text-slate-500 uppercase tracking-widest italic border-t-2 border-white/5 pt-12 group-hover:text-indigo-400 transition-colors duration-300 px-4">
                        ...
                        {template.tags && template.tags.length > 0 && (
                          <div className="flex flex-wrap gap-5 px-4">
                            {template.tags.slice(0, 3).map((tag, index) => (
                              <span key={index} className="text-[11px] font-black text-slate-500 uppercase italic group-hover:text-white transition-colors duration-300 hover:text-indigo-400 cursor-default">
                                #{tag.toUpperCase()}
                              </span>
                            ))}
                          </div>
