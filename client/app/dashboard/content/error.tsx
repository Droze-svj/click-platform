  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-8 text-white">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="max-w-md w-full text-center bg-white/[0.02] border border-white/[0.06] rounded-[2.5rem] p-10">
        <div className="w-14 h-14 bg-[var(--tint-indigo-bg)] border border-[var(--tint-indigo-edge)] rounded-[1.25rem] flex items-center justify-center mx-auto mb-5">
          <Sparkles className="w-7 h-7 text-[var(--tint-indigo-fg)]" />
        </div>
        <h2 className="text-2xl font-black italic mb-3">Content AI <span className="text-[var(--tint-rose-fg)]">Error</span></h2>
        ...
        <div className="flex gap-3">
          <button onClick={reset} className="flex-1 flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-indigo-600/20 border border-[var(--tint-indigo-edge)] text-indigo-300 font-black text-[10px] uppercase tracking-widest hover:bg-indigo-600/30 transition-all">
