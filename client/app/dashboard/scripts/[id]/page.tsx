  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#020205] gap-8">
        ...
        <p className="text-[14px] font-black text-[var(--tint-indigo-fg)] uppercase tracking-[0.8em] animate-pulse italic leading-none">Calibrating Narrative Node...</p>
      </div>
    )
  }
            ...
            <div>
               <div className="flex items-center gap-6 mb-4">
                  <div className="flex items-center gap-3">
                     ...
                     <span className="text-[12px] font-black uppercase tracking-[0.6em] text-[var(--tint-indigo-fg)] italic leading-none">Narrative Node v8.9</span>
                  </div>
               ...
               <div className="flex items-center gap-10 text-[12px] font-black text-slate-500 uppercase tracking-[0.4em] italic leading-none opacity-60">
                 <span className="flex items-center gap-3"><FileText size={16} className="text-[var(--tint-indigo-fg)]" /> {script.wordCount} PARTICLES</span>
                 {script.duration && <span className="flex items-center gap-3"><Clock size={16} className="text-[var(--tint-indigo-fg)]" /> {script.duration} MIN_SYNC</span>}
               </div>
            </div>
          </div>
            ...
            {!editing ? (
              <>
                ...
                <div className="flex gap-4">
                  ...
                  <button
                    ...
                    className="w-16 h-16 rounded-[1.8rem] bg-[var(--tint-indigo-bg)] border-2 border-[var(--tint-indigo-edge)] flex items-center justify-center text-[var(--tint-indigo-fg)] hover:bg-indigo-500 hover:text-white transition-all"
                  >
                    <Code size={24} />
                  </button>
                </div>
              ...
              <div className="flex gap-6">
                ...
                <button
                  ...
                  className="w-16 h-16 rounded-[1.8rem] bg-rose-500/5 border-2 border-[var(--tint-rose-edge)] flex items-center justify-center text-rose-500 hover:bg-rose-500 hover:text-white transition-all"
                >
                  <X size={24} />
                </button>
              </div>
          ...
          {editing ? (
            ...
            <div className="space-y-24">
              <div className="relative">
                 ...
                 <div className="absolute top-8 right-8 flex items-center gap-3 px-6 py-2 rounded-full bg-[var(--tint-indigo-bg)] border border-[var(--tint-indigo-edge)] text-[var(--tint-indigo-fg)] text-[9px] font-black uppercase tracking-widest italic animate-pulse">RAW_NARRATIVE_LATTICE</div>
              </div>
                ...
                <div className="space-y-12">
                   ...
                   <div className="grid grid-cols-1 gap-10">
                    {script.structure.introduction && (
                      <div className="p-12 rounded-[3.5rem] bg-indigo-500/[0.03] border-2 border-[var(--tint-indigo-edge)] shadow-2xl group/item">
                        <h4 className="text-[11px] font-black text-[var(--tint-indigo-fg)] uppercase tracking-[0.5em] mb-6 italic leading-none">00_INTRODUCTION</h4>
                    ...
                    {script.structure.mainPoints.map((point, index) => (
                      <div key={index} className="p-12 rounded-[3.5rem] bg-white/[0.02] border-2 border-white/10 hover:border-[var(--tint-indigo-edge)] transition-all duration-700 shadow-2xl">
                        <div className="flex justify-between items-center mb-6">
                           <h4 className="text-[11px] font-black text-[var(--tint-indigo-fg)] uppercase tracking-[0.5em] italic leading-none">0{index + 1}_{point.title.replace(/\s+/g, '_').toUpperCase()}</h4>
                    ...
                    {script.structure.conclusion && (
                      <div className="p-12 rounded-[3.5rem] bg-indigo-500/[0.03] border-2 border-[var(--tint-indigo-edge)] shadow-2xl">
                        <h4 className="text-[11px] font-black text-[var(--tint-indigo-fg)] uppercase tracking-[0.5em] mb-6 italic leading-none">XX_CONCLUSION</h4>
                    ...
                    {script.structure.callToAction && (
                      <div className="p-12 rounded-[3.5rem] bg-emerald-500/[0.03] border-2 border-[var(--tint-emerald-edge)] shadow-2xl">
                        <h4 className="text-[11px] font-black text-[var(--tint-emerald-fg)] uppercase tracking-[0.5em] mb-6 italic leading-none">FINAL_CONVERSION_HITCH</h4>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                {script.metadata.timestamps && script.metadata.timestamps.length > 0 && (
                  <div className="p-12 rounded-[4rem] bg-black/40 border-2 border-white/5 space-y-10 shadow-3xl">
                    <h3 className="text-[14px] font-black text-white uppercase tracking-[0.6em] mb-8 italic flex items-center gap-4 border-b border-white/5 pb-6"><Clock size={16} className="text-[var(--tint-indigo-fg)]" /> TIMESTAMPS</h3>
                    <div className="space-y-6">
                      {script.metadata.timestamps.map((ts, index) => (
                        <div key={index} className="flex gap-6 items-center p-4 rounded-2xl bg-white/[0.02] border border-white/5 group/ts transition-all duration-700 hover:bg-white/[0.05]">
                          <span className="font-mono font-black text-[var(--tint-indigo-fg)] text-[14px] shadow-inner">{ts.time}</span>
                ...
                {script.metadata.keywords && script.metadata.keywords.length > 0 && (
                  <div className="p-12 rounded-[4rem] bg-black/40 border-2 border-white/5 space-y-10 shadow-3xl">
                    <h3 className="text-[14px] font-black text-white uppercase tracking-[0.6em] mb-8 italic flex items-center gap-4 border-b border-white/5 pb-6"><Key size={16} className="text-[var(--tint-indigo-fg)]" /> LOGIC_KEYS</h3>
                    <div className="flex flex-wrap gap-4">
                      {script.metadata.keywords.map((keyword, index) => (
                        <span key={index} className="bg-[var(--tint-indigo-bg)] border-2 border-[var(--tint-indigo-edge)] text-[var(--tint-indigo-fg)] px-6 py-2 rounded-2xl text-[10px] font-black uppercase tracking-widest italic shadow-3xl hover:bg-indigo-500 hover:text-white transition-all cursor-default">
                          {keyword}
                        </span>
                      ))}
                    </div>
                ...
                {script.metadata.hashtags && script.metadata.hashtags.length > 0 && (
                  <div className="p-12 rounded-[4rem] bg-black/40 border-2 border-white/5 space-y-10 shadow-3xl">
                    <h3 className="text-[14px] font-black text-white uppercase tracking-[0.6em] mb-8 italic flex items-center gap-4 border-b border-white/5 pb-6"><Hash size={16} className="text-[var(--tint-indigo-fg)]" /> SIGNAL_TAGS</h3>
                    <div className="flex flex-wrap gap-4">
                      {script.metadata.hashtags.map((hashtag, index) => (
                        <span key={index} className="bg-[var(--tint-rose-bg)] border-2 border-[var(--tint-rose-edge)] text-[var(--tint-rose-fg)] px-6 py-2 rounded-2xl text-[10px] font-black uppercase tracking-widest italic shadow-3xl hover:bg-rose-500 hover:text-white transition-all cursor-default">
                          #{hashtag}
                        </span>
                      ))}
                    </div>
