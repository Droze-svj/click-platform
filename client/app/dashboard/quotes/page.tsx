        ...
        <header className="flex flex-col lg:flex-row items-center justify-between gap-12 relative z-50">
           <div className="flex items-center gap-10">
              <button 
                ...
                title="Abort Session"
                className="w-20 h-20 rounded-[2.5rem] bg-white/[0.03] border-2 border-white/10 flex items-center justify-center text-slate-400 hover:text-white transition-all duration-700 hover:scale-110 active:scale-90 shadow-3xl hover:border-emerald-500/50 backdrop-blur-3xl group"
              >
              ...
              <div className="p-20 space-y-20 relative z-10">
                 <div className="space-y-10">
                    <div className="flex items-center gap-6 border-l-8 border-emerald-500 pl-8 py-2">
                       <label htmlFor="wisdom-id" className="text-[14px] font-black text-slate-500 uppercase tracking-[0.8em] italic leading-none">Economic Directive Payload</label>
                    </div>
                    <textarea
                      id="wisdom-id"
                      value={wisdomPayload}
                      ...
                      rows={6}
                      className="w-full bg-black/80 border-2 border-white/5 rounded-[4rem] px-20 py-16 text-3xl font-black text-white uppercase tracking-widest italic focus:outline-none focus:border-emerald-500/50 transition-all placeholder:text-slate-600 leading-relaxed resize-none shadow-inner backdrop-blur-3xl"
                      disabled={loading}
                 ...
                 <div className="grid grid-cols-1 xl:grid-cols-2 gap-20">
                    <div className="space-y-12">
                       <div className="flex items-center gap-6 border-l-4 border-slate-900 pl-6 py-1">
                          <label className="text-[14px] font-black text-slate-500 uppercase tracking-[0.6em] italic leading-none">Fiscal Resonance Bias</label>
                       </div>
            ...
            <motion.div initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} className="space-y-16 relative z-10 pt-10">
               <div className="flex items-center justify-between border-b-2 border-white/5 pb-8">
                  ...
                  <button
                    ...
                    className="px-12 py-6 bg-white/[0.03] border-2 border-white/10 rounded-[3rem] text-[13px] font-black uppercase tracking-[0.4em] text-slate-400 hover:text-white hover:bg-white/10 transition-all italic active:scale-95 shadow-3xl group"
                  >
                      ...
                      <div className="p-16 space-y-12 flex-1 flex flex-col justify-between relative z-10">
                         ...
                         <div className="pt-12 flex gap-8">
                            <button
                              ...
                              className="flex-1 flex items-center justify-center gap-6 py-8 bg-white text-black hover:bg-emerald-500 hover:text-white rounded-[3rem] text-[15px] font-black uppercase tracking-[0.6em] transition-all duration-300 italic shadow-3xl group/ext active:scale-95"
                            >
                              <Download size={28} className="group-hover/ext:translate-y-2 transition-transform duration-700" /> EXTRACT_MANIFEST
                            </button>
                            <button 
                               className="w-24 h-24 bg-white/[0.03] border-2 border-white/10 text-slate-400 hover:text-white rounded-[2.5rem] flex items-center justify-center transition-all duration-300 hover:rotate-12 hover:bg-white/10 active:scale-90 hover:border-emerald-500/50 backdrop-blur-3xl group/res"
        ...
        {!fractals.length && !loading && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="py-72 text-center opacity-[0.05] relative z-10 flex flex-col items-center gap-16 grayscale pointer-events-none">
             ...
             <div className="space-y-10">
                ...
                <p className="text-[20px] font-black text-slate-400 uppercase tracking-[0.8em] italic leading-relaxed">No strategic manifests detected in current sector.<br/>Initiate synthesis to activate economic phantoms.</p>
             </div>
          </motion.div>
        )}
