              ...
              {[
                ...
                >
                  ...
                  <div className="flex items-center justify-center mb-12 w-full">
                    <div className={`w-28 h-28 rounded-[3.5rem] ${s.bg} border-2 border-white/5 flex items-center justify-center shadow-2xl group-hover:rotate-12 transition-all duration-300 scale-110 group-hover:border-white/10`}>
