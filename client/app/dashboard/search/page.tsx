  ...
  if (loading && results.length === 0) return (
    <div className="flex flex-col items-center justify-center py-48 bg-[#020205] min-h-screen gap-12 backdrop-blur-3xl">
       ...
       <div className="space-y-4 text-center">
          <p className="text-[14px] font-black text-[var(--tint-indigo-fg)] uppercase tracking-[0.8em] animate-pulse italic leading-none">Probing Registry Lattice...</p>
    ...
    <ErrorBoundary>
      <div className="min-h-screen relative z-10 pb-48 px-10 pt-16 max-w-[1500px] mx-auto space-y-24">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 relative z-50">
           <div className="flex items-center gap-12">
              ...
              <div className="w-24 h-24 bg-[var(--tint-indigo-bg)] border-2 border-[var(--tint-indigo-edge)] rounded-[3rem] flex items-center justify-center shadow-3xl relative group overflow-hidden">
                ...
                <Compass size={48} className="text-[var(--tint-indigo-fg)] relative z-10 group-hover:rotate-180 transition-transform duration-500 ease-in-out" />
              </div>
              <div>
                 <div className="flex items-center gap-6 mb-4">
                   <div className="flex items-center gap-4">
                      <Fingerprint size={16} className="text-[var(--tint-indigo-fg)] animate-pulse" />
                      <span className="text-[12px] font-black uppercase tracking-[0.6em] text-[var(--tint-indigo-fg)] italic leading-none">Signal Interception Grid v12.8</span>
                   </div>
        ...
        <div className={`${glassStyle} rounded-[6rem] p-20 border-white/5 shadow-[0_100px_250px_rgba(0,0,0,1)] relative z-10 overflow-hidden`}>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 md:gap-12 relative z-10">
              <div className="xl:col-span-2 relative group/input">
                 <Search className="absolute left-16 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within/input:text-[var(--tint-indigo-fg)] transition-all duration-300" size={40} />
                 <input
                   id="intercept-input"
                   type="text"
              ...
              <div className="relative group/sel">
                 ...
                 <ChevronRight size={32} className="absolute right-16 top-1/2 -translate-y-1/2 text-white/20 rotate-90 pointer-events-none group-hover/sel:text-[var(--tint-indigo-fg)] transition-colors duration-300" />
              </div>
              ...
              <div className="relative group/stat">
                 ...
                 <ChevronRight size={32} className="absolute right-16 top-1/2 -translate-y-1/2 text-white/20 rotate-90 pointer-events-none group-hover/stat:text-[var(--tint-indigo-fg)] transition-colors duration-300" />
              </div>
           </div>
        </div>
        ...
        <div className="space-y-10 relative z-10">
           {error && (
             <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="p-10 bg-rose-500/5 border border-[var(--tint-rose-edge)] rounded-[3rem] flex items-center gap-8 shadow-2xl">
                 ...
                 {results.map((item, i) => (
                   ...
                   >
                      ...
                      <div className="flex items-center justify-between mb-12">
                         <span className="px-6 py-2 rounded-2xl bg-[var(--tint-indigo-bg)] text-[var(--tint-indigo-fg)] border-2 border-[var(--tint-indigo-edge)] text-[12px] font-black uppercase tracking-widest italic shadow-inner">{item.type.toUpperCase()} // MODALITY</span>
                      ...
                      <h3 className="text-4xl font-black text-white italic uppercase tracking-tighter mb-10 group-hover:text-[var(--tint-indigo-fg)] transition-colors duration-300 leading-none truncate">{item.title || 'UNNAMED_NODE'}</h3>
                      <div className="flex items-center justify-between pt-10 border-t-2 border-white/5">
                         ...
                         <div className="w-16 h-16 rounded-[2rem] bg-[var(--tint-indigo-bg)] border-2 border-[var(--tint-indigo-edge)] flex items-center justify-center text-slate-500 group-hover:text-white group-hover:scale-110 transition-all duration-300">
                            <Eye size={32} />
                         </div>
                      </div>
                   </motion.div>
