...
export const EditorHeader: React.FC<EditorHeaderProps> = ({
    ...
    return (
        <div className={`${isOledTheme ? 'bg-black/80 border-slate-800/50' : 'bg-white/80 dark:bg-gray-800/80 border-gray-200/50 dark:border-gray-700/50'} backdrop-blur-lg border-b p-3 flex-shrink-0 z-30 transition-colors duration-500`}>
