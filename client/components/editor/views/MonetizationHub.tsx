        ...
        <div className="col-span-4 flex flex-col gap-6">
           ...
           <div className="bg-white/[0.02] border border-white/5 rounded-[3rem] p-8 flex-1 flex flex-col gap-6">
              <h3 className="text-[11px] font-black text-white uppercase tracking-widest flex items-center gap-2">
                 <Store className="w-4 h-4 text-[var(--tint-violet-fg)]" />
                 Bridge Health Node
              </h3>
            ...
            <div className="flex items-center justify-between mb-8">
               ...
               <div className="flex items-center gap-4">
                  ...
                  {currentPlan && (
                    ...
                    >
                      <div className={`px-4 py-2 rounded-xl border flex items-center gap-2 ${currentPlan.status === 'finalized' ? 'bg-[var(--tint-emerald-bg)] border-[var(--tint-emerald-edge)] text-[var(--tint-emerald-fg)]' : 'bg-[var(--tint-amber-bg)] border-[var(--tint-amber-edge)] text-[var(--tint-amber-fg)]'}`}>
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                           <div className="flex items-center gap-1 justify-end">
                              ...
                              <span className="text-[9px] font-black text-[var(--tint-emerald-fg)] uppercase">{(step.intentScore * 100).toFixed(0)}% Intent</span>
                           </div>
