        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h4 className="text-2xl font-black text-[var(--text-main)] italic tracking-tighter leading-none uppercase">Fleet Control</h4>
                ...
                {[
                    ...
                    <div key={i} className={`${glassStyle} rounded-3xl p-6 space-y-4`}>
                        ...
                        <div>
                            ...
                            <h3 className="text-2xl font-black text-[var(--text-main)] italic tracking-tighter uppercase">{stat.val}</h3>
                        </div>
                    </div>
                ))}
            </div>
