    ...
    <div className="space-y-16 lg:space-y-24">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-4 relative z-50">
        <div className="flex flex-col md:flex-row items-center gap-10 text-center md:text-left">
          <div className="w-24 h-24 md:w-32 md:h-32 bg-indigo-500/5 border-2 border-[var(--tint-indigo-edge)] rounded-[3rem] md:rounded-[4rem] flex items-center justify-center shadow-[0_40px_150px_rgba(99,102,241,0.3)] relative group overflow-hidden">
             <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/20 to-transparent opacity-100" />
             <Target size={48} className="text-[var(--tint-indigo-fg)] relative z-10 group-hover:scale-125 transition-transform duration-1000 animate-pulse" />
          </div>
          <div>
            <div className="flex flex-col md:flex-row items-center gap-5 mb-5">
              <div className="flex items-center gap-3">
                 <Binary size={14} className="text-[var(--tint-indigo-fg)] animate-pulse" />
                 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[var(--tint-indigo-fg)] italic leading-none">Forge_Module_v4.2.1</span>
              </div>
              <div className="flex items-center gap-3 px-5 py-2 rounded-full bg-[var(--tint-emerald-bg)] border border-[var(--tint-emerald-edge)] shadow-inner">
                  <Activity size={12} className="text-[var(--tint-emerald-fg)] animate-pulse" />
                  <span className="text-[9px] font-black text-[var(--tint-emerald-fg)] tracking-widest uppercase italic leading-none">CORE_SYNC_ACTIVE</span>
              </div>
            </div>
        ...
        <div className="xl:col-span-8 flex flex-col gap-12">
           <div className={`${glassStyle} p-12 lg:p-16 rounded-[5rem] space-y-12 relative overflow-hidden group`}>
              ...
              <div className="space-y-8 relative z-10">
                <div className="flex items-center justify-between px-4">
                  <label className="text-[12px] font-black text-slate-500 uppercase tracking-[0.8em] italic flex items-center gap-4">
                    <Terminal size={18} className="text-[var(--tint-indigo-fg)]" /> PROMPT_INJECTION
                  </label>
                  {loading && (
                    <div className="flex items-center gap-4">
                       {(rateLimitCountdown ?? 0) > 0 ? (
                         <span className="text-[10px] font-black text-[var(--tint-rose-fg)] uppercase italic tracking-widest animate-pulse">冷却 (COOLING): {rateLimitCountdown}S</span>
                       ) : (
                         <span className="text-[10px] font-black text-[var(--tint-indigo-fg)] uppercase italic tracking-widest">COGNITIVE_LOAD: {Math.round(cognitiveLoad)}%</span>
                       )}
                ...
                <textarea
                  ...
                  className="w-full bg-black/60 border-2 border-white/5 rounded-[4rem] p-16 text-[1.8rem] font-black italic text-white placeholder:text-slate-900 focus:outline-none focus:border-[var(--tint-indigo-edge)] transition-all resize-none h-72 shadow-[inset_0_20px_50px_rgba(0,0,0,0.8)] leading-[1.2] uppercase tracking-tighter"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-12 relative z-10 border-t border-white/5 pt-12">
                 ...
                 <div className="md:col-span-12 lg:col-span-8 space-y-8">
                    <div className="flex items-center gap-6 px-4">
                       <Globe size={16} className="text-[var(--tint-indigo-fg)]" />
                 ...
                 <div className="md:col-span-12 space-y-8">
                    <div className="flex items-center gap-6 px-4">
                       <Mic2 size={16} className="text-[var(--tint-indigo-fg)]" />
              ...
              >
                ...
                {loading ? (
                  <>
                    <Loader2 size={48} className="animate-spin text-[var(--tint-indigo-fg)]" />
        ...
        <div className="xl:col-span-4 space-y-12">
           ...
           <div className={`${glassStyle} p-12 rounded-[5rem] space-y-10 bg-black/60 shadow-[inset_0_0_80px_rgba(0,0,0,0.8)] border-white/5`}>
              <div className="flex items-center gap-6">
                 <div className="w-14 h-14 rounded-2xl bg-[var(--tint-indigo-bg)] border border-[var(--tint-indigo-edge)] flex items-center justify-center"><Brain size={28} className="text-[var(--tint-indigo-fg)]" /></div>
                 <div>
           ...
           <div className={`${glassStyle} p-12 rounded-[5rem] space-y-10 border-white/5`}>
              <div className="flex items-center gap-6">
                 <div className="w-14 h-14 rounded-2xl bg-[var(--tint-amber-bg)] border border-[var(--tint-amber-edge)] flex items-center justify-center"><Zap size={28} className="text-[var(--tint-amber-fg)]" /></div>
                 <div>
                 ...
                 <button
                   ...
                   className={`col-span-2 px-6 py-5 rounded-[1.8rem] text-[10px] font-black uppercase tracking-[0.2em] italic border-2 transition-all duration-700 flex items-center justify-between ${
                     stylePivot === 'UGC_RAW'
                       ...
                       : 'bg-white/5 border-white/10 text-slate-600 hover:text-white hover:border-[var(--tint-orange-edge)]'
                   }`}
                 >
              ...
              {stylePivot === 'UGC_RAW' && (
                <motion.div
                  ...
                  className="p-6 rounded-[2rem] bg-orange-500/5 border border-[var(--tint-orange-edge)] mt-4"
                >
                  <div className="flex items-center justify-between mb-3">
                    <p className="text-[9px] font-black text-[var(--tint-orange-fg)] uppercase tracking-widest">Authenticity Engine Active</p>
           ...
           <div className={`${glassStyle} p-12 rounded-[5rem] border-white/5 relative overflow-hidden group h-[400px]`}>
              <div className="absolute inset-0 opacity-[0.05] pointer-events-none p-12"><Orbit size={400} className="text-[var(--tint-indigo-fg)] animate-spin-slow rotate-45" /></div>
              <div className="flex flex-col h-full relative z-10">
                 <div className="flex items-center gap-6 mb-12">
                    <div className="w-12 h-12 rounded-xl bg-[var(--tint-emerald-bg)] border border-[var(--tint-emerald-edge)] flex items-center justify-center animate-pulse"><Waves size={24} className="text-[var(--tint-emerald-fg)]" /></div>
                 ...
                 <div className="flex-1 space-y-8">
                    {STAGES.map((s, i) => (
                       <div key={s.id} className="flex items-center gap-8 relative">
                          ...
                          <div>
                             <p className={`text-[12px] font-black uppercase tracking-tighter italic leading-none ${completedStages.includes(s.id) ? 'text-white' : currentStage === s.id ? 'text-[var(--tint-indigo-fg)]' : 'text-slate-800'}`}>{s.label}</p>
      ...
      <AnimatePresence mode="wait">
        {result && (
          <motion.div
            ...
            className={`${glassStyle} p-16 lg:p-24 rounded-[6rem] bg-emerald-500/5 border-[var(--tint-emerald-edge)] shadow-[0_80px_200px_rgba(0,0,0,1)] relative overflow-hidden`}
          >
            <div className="absolute top-0 right-0 p-24 opacity-[0.03] pointer-events-none rotate-12 group-hover:opacity-[0.1] transition-opacity duration-[2s]">
               <Box size={500} className="text-[var(--tint-emerald-fg)]" />
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-16 border-b-2 border-white/5 pb-20 relative z-10">
              <div className="flex items-center gap-12">
                <div className="w-28 h-28 rounded-[3rem] bg-[var(--tint-emerald-bg)] border-2 border-[var(--tint-emerald-edge)] flex items-center justify-center shadow-3xl group-hover:rotate-12 transition-transform duration-1000">
                  <CheckCircle2 size={56} className="text-[var(--tint-emerald-fg)]" />
                </div>
                <div>
                  ...
                  <div className="flex flex-wrap gap-4">
                     <div className="px-6 py-2 rounded-full bg-[var(--tint-emerald-bg)] border border-[var(--tint-emerald-edge)] text-[10px] font-black text-[var(--tint-emerald-fg)] uppercase italic tracking-widest leading-none">MANIFEST_STABLE</div>
                     ...
                     <div className="px-6 py-2 rounded-full bg-[var(--tint-indigo-bg)] border border-[var(--tint-indigo-edge)] text-[10px] font-black text-[var(--tint-indigo-fg)] uppercase italic tracking-widest leading-none">PIVOT: {result.pivot || 'BALANCED'}</div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-8">
                 ...
                 <button 
                  onClick={() => runFactory()}
                  disabled={loading}
                  className="px-10 py-6 rounded-[2.5rem] bg-[var(--tint-indigo-bg)] border-2 border-[var(--tint-indigo-edge)] text-[var(--tint-indigo-fg)] font-black text-[12px] uppercase tracking-widest hover:bg-indigo-500 hover:text-white transition-all italic active:scale-95 flex items-center gap-5 shadow-inner"
                 >
                 ...
                 <button 
                  ...
                  className="px-10 py-6 rounded-[2.5rem] bg-[var(--tint-indigo-bg)] border-2 border-[var(--tint-indigo-edge)] text-[var(--tint-indigo-fg)] font-black text-[12px] uppercase tracking-widest hover:bg-emerald-500 hover:text-white transition-all italic active:scale-95 flex items-center gap-5 shadow-inner"
                 >
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-24 relative z-10 pt-12">
               ...
               <div className="space-y-16">
                  <div className="space-y-8">
                     <p className="text-[12px] font-black text-slate-500 uppercase tracking-[0.8em] italic flex items-center gap-5">
                        <Fingerprint size={16} className="text-[var(--tint-emerald-fg)] animate-pulse" /> MANIFESTED_IDENTITY
                     </p>
                  ...
                  <div className="space-y-8">
                     <p className="text-[12px] font-black text-slate-500 uppercase tracking-[0.8em] italic flex items-center gap-5">
                        <Command size={16} className="text-[var(--tint-indigo-fg)]" /> STRATEGIC_HOOK_v12
                     </p>
                     <p className="text-3xl md:text-4xl text-slate-300 leading-tight italic border-l-[10px] border-[var(--tint-emerald-edge)] pl-12 font-bold uppercase tracking-tight group-hover:text-white transition-colors duration-1000">
                  ...
                  <div className="grid grid-cols-2 gap-12 pt-8">
                    <div className="p-10 rounded-[3.5rem] bg-black/40 border-2 border-white/5 space-y-5 shadow-inner group hover:border-[var(--tint-emerald-edge)] transition-all">
                       <p className="text-[10px] font-black text-slate-800 uppercase tracking-[0.4em] italic group-hover:text-[var(--tint-emerald-fg)] transition-colors">TEMPORAL_DURATION</p>
                    ...
                    <div className="p-10 rounded-[3.5rem] bg-black/40 border-2 border-white/5 space-y-5 shadow-inner group hover:border-[var(--tint-emerald-edge)] transition-all">
                       <p className="text-[10px] font-black text-slate-800 uppercase tracking-[0.4em] italic group-hover:text-[var(--tint-emerald-fg)] transition-colors">DOMAIN_LATTICE</p>
               ...
               <div className="space-y-12">
                  <div className={`${glassStyle} p-12 lg:p-14 rounded-[4.5rem] bg-indigo-500/5 border-2 border-[var(--tint-indigo-edge)] space-y-8 shadow-[0_50px_150px_rgba(0,0,0,0.8)] relative overflow-hidden group/advice`}>
                     <div className="absolute top-0 right-0 p-12 opacity-0 group-hover/advice:opacity-10 transition-opacity duration-1000">
                        <Brain size={180} className="text-[var(--tint-indigo-fg)]" />
                     </div>
                     <div className="flex items-center justify-between relative z-10">
                        <p className="text-[12px] font-black text-[var(--tint-indigo-fg)] uppercase tracking-[0.8em] italic flex items-center gap-5">
                           <Sparkle size={18} className="animate-pulse" /> STRATEGIC_ORACLE_ADVICE
                        </p>
                        <div className="px-5 py-2 rounded-full bg-[var(--tint-indigo-bg)] border border-[var(--tint-indigo-edge)] text-[9px] font-black text-[var(--tint-indigo-fg)] italic">v2026.4_LATTICE</div>
                     </div>
                     <div className="space-y-6 relative z-10">
                        ...
                        <div className="flex flex-wrap gap-6 pt-4">
                           <div className="flex flex-col gap-2">
                              ...
                              <span className="text-4xl font-black text-[var(--tint-emerald-fg)] italic tabular-nums leading-none shadow-emerald-500/20 drop-shadow-[0_0_10px_rgba(16,185,129,0.5)]">{result.summary?.globalConsensus || '98.4%'}</span>
                           </div>
                           ...
                           <div className="flex flex-col gap-2 border-l border-white/5 pl-8">
                              ...
                              <span className="text-2xl font-black text-[var(--tint-indigo-fg)] italic leading-none uppercase tracking-widest">{stylePivot}</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="p-12 rounded-[4.5rem] bg-gradient-to-br from-indigo-500/20 via-violet-800/20 to-transparent border-2 border-[var(--tint-indigo-edge)] flex flex-col md:flex-row items-center text-center md:text-left gap-12 shadow-[0_60px_180px_rgba(0,0,0,1)] relative overflow-hidden group">
                     <div className="absolute inset-0 bg-white/5 animate-shimmer opacity-20 pointer-events-none" />
                     <div className="w-24 h-24 rounded-[3rem] bg-[var(--tint-indigo-bg)] border-2 border-[var(--tint-indigo-edge)] flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-1000 group-hover:rotate-12">
                        <Film size={44} className="text-[var(--tint-indigo-fg)]" />
                     </div>
      ...
      {error && (
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1, y: 0 }}
          className="p-16 rounded-[4.5rem] bg-rose-500/5 border-2 border-[var(--tint-rose-edge)] flex flex-col md:flex-row items-center gap-12 shadow-2xl backdrop-blur-3xl relative z-50 overflow-hidden"
        >
          <div className="absolute inset-0 bg-rose-500/[0.02] animate-pulse pointer-events-none" />
          <div className="w-24 h-24 rounded-[3rem] bg-[var(--tint-rose-bg)] flex items-center justify-center shadow-xl border-2 border-[var(--tint-rose-edge)] relative z-10">
             <AlertCircle size={48} className="text-[var(--tint-rose-fg)] animate-pulse" />
          </div>
        ...
        {[
          ...
          <div key={tip.title} className={`${glassStyle} p-12 rounded-[4rem] group hover:bg-white/[0.05] transition-all cursor-crosshair border-white/5`}>
             <div className="w-16 h-16 rounded-[2rem] bg-white/5 border border-white/10 flex items-center justify-center mb-10 shadow-inner group-hover:rotate-12 group-hover:scale-110 transition-all duration-1000">
                <tip.icon size={32} className="text-slate-800 group-hover:text-[var(--tint-indigo-fg)] transition-colors" />
             </div>
             <p className="text-2xl font-black text-white italic uppercase tracking-tighter mb-4 group-hover:text-[var(--tint-indigo-fg)] transition-colors leading-none">{tip.title}</p>
