...
// LazyMotion + the `m` shorthand load only the animation features we use
// (~12kb less than the default `motion` import). domAnimation is enough
// for opacity/transform — no layout/drag/gestures needed here.
