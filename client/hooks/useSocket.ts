...
export function useSocket(userId?: string | null): UseSocketReturn {
  ...
  useEffect(() => {
    ...
    // Enable WebSocket connection in development to allow real-time dashboard features
    // Ensure the backend websocket server is running or this will just retry silently
