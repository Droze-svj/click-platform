...
echo "   Run this command (replace CODE with the code from callback):"
echo ""
echo "   ./scripts/finish-youtube-oauth.sh \"CODE_FROM_CALLBACK\" \"$STATE\" \"$TOKEN\""
echo ""
echo "   Or manually:"
echo "   curl -X POST $SERVICE_URL/api/oauth/youtube/complete \\"
echo "     -H \"Authorization: Bearer $TOKEN\" \\"
echo "     -H 'Content-Type: application/json' \\"
echo "     -d '{\"code\": \"CODE_FROM_CALLBACK\", \"state\": \"$STATE\"}'"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
