...
class LinkedInSocialService {
  ...
  static async postToLinkedIn(auth, contentData) {
    ...
    const authorUrn = auth.linkedInUrn; // Typically "urn:li:person:XXXX" or "urn:li:organization:XXXX"

    if (!authorUrn) throw new Error('LinkedIn URN missing from credentials');
