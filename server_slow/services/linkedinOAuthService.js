...
function defaultRedirectUri() {
  return process.env.LINKEDIN_CALLBACK_URL ||
    `${process.env.API_URL || process.env.FRONTEND_URL || 'http://localhost:5001'}/api/oauth/linkedin/callback`;
}
 ...
 */
async function getAuthorizationUrl(userId, state) {
