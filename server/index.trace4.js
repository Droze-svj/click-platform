...
console.log('REQUIRING automatedSurveyService'); const { scheduleAutomatedSurveys } = require('./services/automatedSurveyService'); console.log('REQUIRED automatedSurveyService');
if (process.env.NODE_ENV !== 'test') {
  try {
