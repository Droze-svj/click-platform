...
// (`(req,res,next) => next()`) let ANY authenticated user pass — and these routes
// write provider apiKey/apiSecret config. If this file is ever mounted, a
// non-admin must not reach them.
