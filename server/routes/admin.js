...
router.get('/dashboard', auth, requireAdmin, asyncHandler(async (req, res) => {
  try {
    ...
    logger.error('Failed to load admin dashboard', { error: error.message });
    res.status(500).json({
      success: false,
...
router.get('/users', auth, requireAdmin, asyncHandler(async (req, res) => {
  try {
    ...
    logger.error('Failed to load users for admin', { error: error.message });
    res.status(500).json({
      success: false,
...
router.get('/users/:id', auth, requireAdmin, asyncHandler(async (req, res) => {
  try {
    ...
    logger.error('Failed to load user details for admin', { error: error.message, userId: req.params.id });
    res.status(500).json({
      success: false,
...
router.get('/posts', auth, requireAdmin, asyncHandler(async (req, res) => {
  try {
    ...
    logger.error('Failed to load posts for admin', { error: error.message });
    res.status(500).json({
      success: false,
...
router.put('/posts/:id/moderate', auth, requireAdmin, asyncHandler(async (req, res) => {
  try {
    ...
    logger.error('Failed to moderate post', { error: error.message, postId: req.params.id });
    res.status(500).json({
      success: false,
...
router.get('/analytics', auth, requireAdmin, asyncHandler(async (req, res) => {
  try {
    ...
    logger.error('Failed to load admin analytics', { error: error.message });
    res.status(500).json({
      success: false,
