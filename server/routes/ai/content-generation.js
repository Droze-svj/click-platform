...
router.post('/advanced', auth, checkGenerationQuota, asyncHandler(async (req, res) => {
...
router.post('/variations', auth, checkGenerationQuota, asyncHandler(async (req, res) => {
...
router.post('/template', auth, checkGenerationQuota, asyncHandler(async (req, res) => {
