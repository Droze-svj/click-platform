...
console.log('REQUIRING EXPRESS'); const express = require('express'); console.log('EXPRESS REQUIRED');
const cors = require('cors');
console.log('REQUIRING MONGOOSE'); const mongoose = require('mongoose'); console.log('MONGOOSE REQUIRED');
const fs = require('fs');
