...
console.log('REQUIRING fs'); const fs = require('fs'); console.log('REQUIRED fs');
console.log('REQUIRING helmet'); const helmet = require('helmet'); console.log('REQUIRED helmet');
console.log('REQUIRING compression'); const compression = require('compression'); console.log('REQUIRED compression');
