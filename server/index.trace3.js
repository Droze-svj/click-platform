...
let Sentry = null;
try {
  // Bypassed Sentry initialization entirely as it hangs on iCloud Drive
...
const cors = (console.log('REQUIRING cors'), function() { try { const r = require('cors'); console.log('REQUIRED cors'); return r; } catch(e) { console.log('ERROR REQUIRING cors:', e.message); throw e; } })();
const mongoose = require('mongoose');
const fs = (console.log('REQUIRING fs'), function() { try { const r = require('fs'); console.log('REQUIRED fs'); return r; } catch(e) { console.log('ERROR REQUIRING fs:', e.message); throw e; } })();
const helmet = (console.log('REQUIRING helmet'), function() { try { const r = require('helmet'); console.log('REQUIRED helmet'); return r; } catch(e) { console.log('ERROR REQUIRING helmet:', e.message); throw e; } })();
const compression = (console.log('REQUIRING compression'), function() { try { const r = require('compression'); console.log('REQUIRED compression'); return r; } catch(e) { console.log('ERROR REQUIRING compression:', e.message); throw e; } })();
const { securityHeaders, customSecurityHeaders } = (console.log('REQUIRING ./middleware/securityHeaders'), function() { try { const r = require('./middleware/securityHeaders'); console.log('REQUIRED ./middleware/securityHeaders'); return r; } catch(e) { console.log('ERROR REQUIRING ./middleware/securityHeaders:', e.message); throw e; } })();
const cron = (console.log('REQUIRING node-cron'), function() { try { const r = require('node-cron'); console.log('REQUIRED node-cron'); return r; } catch(e) { console.log('ERROR REQUIRING node-cron:', e.message); throw e; } })();
const swaggerUi = (console.log('REQUIRING swagger-ui-express'), function() { try { const r = require('swagger-ui-express'); console.log('REQUIRED swagger-ui-express'); return r; } catch(e) { console.log('ERROR REQUIRING swagger-ui-express:', e.message); throw e; } })();
let swaggerSpec = null;
try {
  swaggerSpec = (console.log('REQUIRING ./config/swagger'), function() { try { const r = require('./config/swagger'); console.log('REQUIRED ./config/swagger'); return r; } catch(e) { console.log('ERROR REQUIRING ./config/swagger:', e.message); throw e; } })();
} catch (err) {
...
const validateEnv = (console.log('REQUIRING ./middleware/validateEnv'), function() { try { const r = require('./middleware/validateEnv'); console.log('REQUIRED ./middleware/validateEnv'); return r; } catch(e) { console.log('ERROR REQUIRING ./middleware/validateEnv:', e.message); throw e; } })();
const { errorHandler, notFound } = (console.log('REQUIRING ./middleware/errorHandler'), function() { try { const r = require('./middleware/errorHandler'); console.log('REQUIRED ./middleware/errorHandler'); return r; } catch(e) { console.log('ERROR REQUIRING ./middleware/errorHandler:', e.message); throw e; } })();
const { enhancedErrorHandler, notFoundHandler, initErrorHandlers } = (console.log('REQUIRING ./middleware/enhancedErrorHandler'), function() { try { const r = require('./middleware/enhancedErrorHandler'); console.log('REQUIRED ./middleware/enhancedErrorHandler'); return r; } catch(e) { console.log('ERROR REQUIRING ./middleware/enhancedErrorHandler:', e.message); throw e; } })();
const { apiLimiter } = (console.log('REQUIRING ./middleware/enhancedRateLimiter'), function() { try { const r = require('./middleware/enhancedRateLimiter'); console.log('REQUIRED ./middleware/enhancedRateLimiter'); return r; } catch(e) { console.log('ERROR REQUIRING ./middleware/enhancedRateLimiter:', e.message); throw e; } })();
const requestLogger = (console.log('REQUIRING ./middleware/requestLogger'), function() { try { const r = require('./middleware/requestLogger'); console.log('REQUIRED ./middleware/requestLogger'); return r; } catch(e) { console.log('ERROR REQUIRING ./middleware/requestLogger:', e.message); throw e; } })();
const { requestTimeoutRouteAware, getTimeoutForRoute } = (console.log('REQUIRING ./middleware/requestTimeout'), function() { try { const r = require('./middleware/requestTimeout'); console.log('REQUIRED ./middleware/requestTimeout'); return r; } catch(e) { console.log('ERROR REQUIRING ./middleware/requestTimeout:', e.message); throw e; } })();
const { cleanupOldFiles } = (console.log('REQUIRING ./utils/fileCleanup'), function() { try { const r = require('./utils/fileCleanup'); console.log('REQUIRED ./utils/fileCleanup'); return r; } catch(e) { console.log('ERROR REQUIRING ./utils/fileCleanup:', e.message); throw e; } })();
// logger is already imported above (needed for error handlers)
const { initializeSocket } = (console.log('REQUIRING ./services/socketService'), function() { try { const r = require('./services/socketService'); console.log('REQUIRED ./services/socketService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/socketService:', e.message); throw e; } })();
const { trackResponseTime } = (console.log('REQUIRING ./utils/performance'), function() { try { const r = require('./utils/performance'); console.log('REQUIRED ./utils/performance'); return r; } catch(e) { console.log('ERROR REQUIRING ./utils/performance:', e.message); throw e; } })();
...
try {
  const { initEmailService } = (console.log('REQUIRING ./services/emailService'), function() { try { const r = require('./services/emailService'); console.log('REQUIRED ./services/emailService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/emailService:', e.message); throw e; } })();
  initEmailService();
} catch (error) {
...
const { initCache } = (console.log('REQUIRING ./services/cacheService'), function() { try { const r = require('./services/cacheService'); console.log('REQUIRED ./services/cacheService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/cacheService:', e.message); throw e; } })();
initCache().catch(err => {
...
try {
  const { initIntelligentCache } = (console.log('REQUIRING ./services/intelligentCacheService'), function() { try { const r = require('./services/intelligentCacheService'); console.log('REQUIRED ./services/intelligentCacheService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/intelligentCacheService:', e.message); throw e; } })();
...
let redisCache = null;
try {
  redisCache = (console.log('REQUIRING ./utils/redisCache'), function() { try { const r = require('./utils/redisCache'); console.log('REQUIRED ./utils/redisCache'); return r; } catch(e) { console.log('ERROR REQUIRING ./utils/redisCache:', e.message); throw e; } })();
...
try {
  const { apmMonitor, apmMiddleware: apmMiddlewareExport } = (console.log('REQUIRING ./utils/apm'), function() { try { const r = require('./utils/apm'); console.log('REQUIRED ./utils/apm'); return r; } catch(e) { console.log('ERROR REQUIRING ./utils/apm:', e.message); throw e; } })();
...
try {
  const alertingSystem = (console.log('REQUIRING ./utils/alerting'), function() { try { const r = require('./utils/alerting'); console.log('REQUIRED ./utils/alerting'); return r; } catch(e) { console.log('ERROR REQUIRING ./utils/alerting:', e.message); throw e; } })();
...
try {
  apiOptimizer = (console.log('REQUIRING ./middleware/apiOptimizer'), function() { try { const r = require('./middleware/apiOptimizer'); console.log('REQUIRED ./middleware/apiOptimizer'); return r; } catch(e) { console.log('ERROR REQUIRING ./middleware/apiOptimizer:', e.message); throw e; } })();
...
try {
  const databaseOptimizer = (console.log('REQUIRING ./utils/databaseOptimizer'), function() { try { const r = require('./utils/databaseOptimizer'); console.log('REQUIRED ./utils/databaseOptimizer'); return r; } catch(e) { console.log('ERROR REQUIRING ./utils/databaseOptimizer:', e.message); throw e; } })();
...
if (process.env.NODE_ENV !== 'test') {
  ...
  if (shouldInitializeWorkers) {
    ...
    if (!backgroundJobsEnabled) {
      ...
      try {
        const { initializeWorkers } = (console.log('REQUIRING ./queues'), function() { try { const r = require('./queues'); console.log('REQUIRED ./queues'); return r; } catch(e) { console.log('ERROR REQUIRING ./queues:', e.message); throw e; } })();
        const { initializeScheduler } = (console.log('REQUIRING ./services/jobScheduler'), function() { try { const r = require('./services/jobScheduler'); console.log('REQUIRED ./services/jobScheduler'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/jobScheduler:', e.message); throw e; } })();
        initializeWorkers();
...
const { startSLAMonitoring } = (console.log('REQUIRING ./services/slaCronService'), function() { try { const r = require('./services/slaCronService'); console.log('REQUIRED ./services/slaCronService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/slaCronService:', e.message); throw e; } })();
try {
  startSLAMonitoring();
...
const { initializeValueTrackingHooks } = (console.log('REQUIRING ./services/valueTrackingHooks'), function() { try { const r = require('./services/valueTrackingHooks'); console.log('REQUIRED ./services/valueTrackingHooks'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/valueTrackingHooks:', e.message); throw e; } })();
try {
...
const { startMonthlyCalculationCron, startTierCheckCron } = (console.log('REQUIRING ./services/valueTrackingCronService'), function() { try { const r = require('./services/valueTrackingCronService'); console.log('REQUIRED ./services/valueTrackingCronService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/valueTrackingCronService:', e.message); throw e; } })();
if (process.env.NODE_ENV !== 'test') {
  try {
...
const { scheduleUpgradeChecks } = (console.log('REQUIRING ./services/modelVersionManager'), function() { try { const r = require('./services/modelVersionManager'); console.log('REQUIRED ./services/modelVersionManager'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/modelVersionManager:', e.message); throw e; } })();
const { scheduleRolloutIncrements } = (console.log('REQUIRING ./services/modelVersionGradualRollout'), function() { try { const r = require('./services/modelVersionGradualRollout'); console.log('REQUIRED ./services/modelVersionGradualRollout'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/modelVersionGradualRollout:', e.message); throw e; } })();
if (process.env.NODE_ENV !== 'test') {
  try {
...
const { startAudienceGrowthCron } = (console.log('REQUIRING ./services/audienceGrowthCronService'), function() { try { const r = require('./services/audienceGrowthCronService'); console.log('REQUIRED ./services/audienceGrowthCronService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/audienceGrowthCronService:', e.message); throw e; } })();
if (process.env.NODE_ENV !== 'test') {
  try {
...
const { scheduleHealthReports } = (console.log('REQUIRING ./services/healthReportSchedulerService'), function() { try { const r = require('./services/healthReportSchedulerService'); console.log('REQUIRED ./services/healthReportSchedulerService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/healthReportSchedulerService:', e.message); throw e; } })();
if (process.env.NODE_ENV !== 'test') {
  try {
...
const { syncAllCompetitors } = (console.log('REQUIRING ./services/competitorMonitoringService'), function() { try { const r = require('./services/competitorMonitoringService'); console.log('REQUIRED ./services/competitorMonitoringService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/competitorMonitoringService:', e.message); throw e; } })();
if (process.env.NODE_ENV !== 'test') {
  try {
...
const { scheduleAutomatedSurveys } = (console.log('REQUIRING ./services/automatedSurveyService'), function() { try { const r = require('./services/automatedSurveyService'); console.log('REQUIRED ./services/automatedSurveyService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/automatedSurveyService:', e.message); throw e; } })();
if (process.env.NODE_ENV !== 'test') {
  try {
...
const { checkBusinessAlerts } = (console.log('REQUIRING ./services/businessAlertService'), function() { try { const r = require('./services/businessAlertService'); console.log('REQUIRED ./services/businessAlertService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/businessAlertService:', e.message); throw e; } })();
if (process.env.NODE_ENV !== 'test') {
  try {
...
const { checkSLAAlerts } = (console.log('REQUIRING ./services/slaAlertService'), function() { try { const r = require('./services/slaAlertService'); console.log('REQUIRED ./services/slaAlertService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/slaAlertService:', e.message); throw e; } })();
if (process.env.NODE_ENV !== 'test') {
  try {
...
const { processScheduledReports } = (console.log('REQUIRING ./services/scheduledReportService'), function() { try { const r = require('./services/scheduledReportService'); console.log('REQUIRED ./services/scheduledReportService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/scheduledReportService:', e.message); throw e; } })();
if (process.env.NODE_ENV !== 'test') {
  try {
    cron.schedule('0 * * * *', async () => {
      try {
...
try {
  const { initQueryMonitoring } = (console.log('REQUIRING ./services/queryPerformanceMonitor'), function() { try { const r = require('./services/queryPerformanceMonitor'); console.log('REQUIRED ./services/queryPerformanceMonitor'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/queryPerformanceMonitor:', e.message); throw e; } })();
  initQueryMonitoring();
...
const { initElasticsearch } = (console.log('REQUIRING ./services/elasticsearchService'), function() { try { const r = require('./services/elasticsearchService'); console.log('REQUIRED ./services/elasticsearchService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/elasticsearchService:', e.message); throw e; } })();
initElasticsearch().catch(err => {
  logger.warn('Elasticsearch initialization failed', { error: err.message });
});

// Initialize CDN
const { initCDN } = (console.log('REQUIRING ./services/cdnService'), function() { try { const r = require('./services/cdnService'); console.log('REQUIRED ./services/cdnService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/cdnService:', e.message); throw e; } })();
initCDN().catch(err => {
  logger.warn('CDN initialization failed', { error: err.message });
});

// Initialize database sharding
const { initSharding } = (console.log('REQUIRING ./services/databaseShardingService'), function() { try { const r = require('./services/databaseShardingService'); console.log('REQUIRED ./services/databaseShardingService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/databaseShardingService:', e.message); throw e; } })();
...
try {
  (console.log('REQUIRING ./middleware/monitoringMiddleware'), function() { try { const r = require('./middleware/monitoringMiddleware'); console.log('REQUIRED ./middleware/monitoringMiddleware'); return r; } catch(e) { console.log('ERROR REQUIRING ./middleware/monitoringMiddleware:', e.message); throw e; } })();
} catch (error) {
...
try {
  const { initFailoverMonitoring } = (console.log('REQUIRING ./services/automatedFailoverService'), function() { try { const r = require('./services/automatedFailoverService'); console.log('REQUIRED ./services/automatedFailoverService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/automatedFailoverService:', e.message); throw e; } })();
...
if (process.env.NODE_ENV === 'production') {
  const { startMonitoring } = (console.log('REQUIRING ./services/alertingService'), function() { try { const r = require('./services/alertingService'); console.log('REQUIRED ./services/alertingService'); return r; } catch(e) { console.log('ERROR REQUIRING ./services/alertingService:', e.message); throw e; } })();
...
if (process.env.NODE_ENV === 'production') {
  const { initProduction } = (console.log('REQUIRING ./config/production'), function() { try { const r = require('./config/production'); console.log('REQUIRED ./config/production'); return r; } catch(e) { console.log('ERROR REQUIRING ./config/production:', e.message); throw e; } })();
  try {
    initProduction();
  } catch (error) {
