...
console.log('REACHED: ' + `const app = express();`); const app = express();
...
console.log('REACHED: ' + `app.use(compression());`); app.use(compression());

// Security headers (must be before other middleware)
console.log('REACHED: ' + `app.use(securityHeaders());`); app.use(securityHeaders());
console.log('REACHED: ' + `app.use(customSecurityHeaders);`); app.use(customSecurityHeaders);
...
// 404 handler
console.log('REACHED: ' + `app.use(notFound);`); app.use(notFound);
...
console.log('REACHED: ' + `app.use(errorHandler);`); app.use(errorHandler);
