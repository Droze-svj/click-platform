...
console.log('REQUIRING validateEnv'); const validateEnv = require('./middleware/validateEnv');
console.log('REQUIRING errorHandler'); const { errorHandler, notFound } = require('./middleware/errorHandler');
console.log('REQUIRING enhancedErrorHandler'); const { enhancedErrorHandler, notFoundHandler, initErrorHandlers } = require('./middleware/enhancedErrorHandler');
